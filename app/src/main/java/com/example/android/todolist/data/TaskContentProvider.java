...
public class TaskContentProvider extends ContentProvider {
    ...
    public static int TASKS_WITH_ID = 101;
    // TODO (3) Declare a static variable for the Uri matcher that you construct
    public static UriMatcher sUrlMatcher = buildUriMatcher();
    ...
    public static UriMatcher buildUriMatcher() {
        ...
        matcher.addURI(TaskContract.AUTHORITY, TaskContract.PATH_TASKS + "/#", TASKS_WITH_ID);
        return matcher;
    }
